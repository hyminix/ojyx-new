// --- Models/Deck.cs --- (Logique de pioche inversée)
...
        // MODIFICATION : Piocher la *dernière* carte.
...
        public Card DrawCard()

        {
            ...
            Card drawn = cards[cards.Count - 1]; // On prend la dernière

            cards.RemoveAt(cards.Count - 1);      // On supprime la dernière
